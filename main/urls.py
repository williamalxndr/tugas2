...
from main.views import show_main, create_new_product, show_xml, show_json, show_xml_by_id, show_json_by_id, register, login_user, logout_user, delete_product, edit_product, show_product, show_product_by_category
